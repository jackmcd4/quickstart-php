...
class AccountsApi
{
     ...
     * Get account
     *
     * @param string $account_key Account number or account ID. (required)
    ...
    public function getAccountWithHttpInfo($account_key)
    {
        ...
        if ($account_key === null) {
            throw new \InvalidArgumentException('Missing the required parameter $account_key when calling gETAccount');
        }
        // parse inputs
        $resourcePath = "/accounts/{account-key}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\GETAccountType',
                '/accounts/{account-key}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GETAccountType', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\GETAccountType', $e->getResponseHeaders());
    ...
    public function getAccountSummaryWithHttpInfo($account_key)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\GETAccountSummaryType', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * Create account
     *
     * @param \Swagger\Client\Model\POSTAccountType $request  (required)
     * @param string $zuora_version The minor version of the Zuora REST API. You only need to set this parameter if you use the __collect__ or __invoice__ fields. See [REST API Basics](https://knowledgecenter.zuora.com/DC_Developers/REST_API/A_REST_basics) for more information. (optional)
    ...
    /**
     * Operation pOSTAccountWithHttpInfo
     *
     * Create account
     *
     * @param \Swagger\Client\Model\POSTAccountType $request  (required)
    ...
    public function postAccountWithHttpInfo($request, $zuora_version = null)
    {
        ...
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling pOSTAccount');
        }
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\POSTAccountResponseType',
                '/accounts'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\POSTAccountResponseType', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\POSTAccountResponseType', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param string $account_key Account number or account ID. (required)
     * @param \Swagger\Client\Model\PUTAccountType $request  (required)
    ...
    /**
     * Operation pUTAccountWithHttpInfo
     *
     * Update account
     *
     * @param string $account_key Account number or account ID. (required)
    ...
    public function putAccountWithHttpInfo($account_key, $request)
    {
        // verify the required parameter 'account_key' is set
        if ($account_key === null) {
            throw new \InvalidArgumentException('Missing the required parameter $account_key when calling pUTAccount');
        }
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling pUTAccount');
        }
        // parse inputs
        $resourcePath = "/accounts/{account-key}";
        $httpBody = '';
    ...
    /**
     * Operation proxyDELETEAccountWithHttpInfo
     *
     * CRUD: Delete Account
     *
     * @param string $id Object id (required)
    ...
    public function proxyDeleteAccountWithHttpInfo($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling proxyDELETEAccount');
        }
        // parse inputs
        $resourcePath = "/object/account/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation proxyGETAccountWithHttpInfo
     *
     * CRUD: Retrieve Account
     *
     * @param string $id Object id (required)
    ...
    public function proxyGetAccountWithHttpInfo($id, $fields = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling proxyGETAccount');
        }
        // parse inputs
        $resourcePath = "/object/account/{id}";
        $httpBody = '';
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProxyGetAccount',
                '/object/account/{id}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProxyGetAccount', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProxyGetAccount', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
    ...
    /**
     * Operation proxyPOSTAccount
     *
     * CRUD: Create Account
     *
     * @param \Swagger\Client\Model\ProxyCreateAccount $create_request  (required)
    ...
    /**
     * Operation proxyPOSTAccountWithHttpInfo
     *
     * CRUD: Create Account
     *
     * @param \Swagger\Client\Model\ProxyCreateAccount $create_request  (required)
    ...
    public function proxyPostAccountWithHttpInfo($create_request)
    {
        ...
        if ($create_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $create_request when calling proxyPOSTAccount');
        }
        // parse inputs
        $resourcePath = "/object/account";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation proxyPUTAccount
     *
     * CRUD: Update Account
     *
     * @param string $id Object id (required)
     * @param \Swagger\Client\Model\ProxyModifyAccount $modify_request  (required)
     * @return \Swagger\Client\Model\ProxyCreateOrModifyResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    ...
    /**
     * Operation proxyPUTAccountWithHttpInfo
     *
     * CRUD: Update Account
     *
     * @param string $id Object id (required)
    ...
    public function proxyPutAccountWithHttpInfo($id, $modify_request)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling proxyPUTAccount');
        }
        // verify the required parameter 'modify_request' is set
        if ($modify_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $modify_request when calling proxyPUTAccount');
        }
        // parse inputs
        $resourcePath = "/object/account/{id}";
        $httpBody = '';
